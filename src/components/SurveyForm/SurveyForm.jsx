...
import useValidation3 from "../../hooks/useValidation3";
...
const SurveyForm = () => {
  ...
  const { formValues, handleChange, handleSubmit } = useForm3(
    initialFormState,
    handleFormSubmit
  );

  const { errors, validateForm } = useValidation3(formValues, surveyTopic);
  ...
  return (
    <div className="form-container-3">
      <div className="h1-level3">
        <h1>Form Level 3</h1>
      </div>
      <div className="level-3-body">
              ...
              <>
                ...
                <div className="form-group-33">
                  ...
                  {errors.dietPreference && (
                    <span>{errors.dietPreference}</span>
                  )}
                </div>
              </>
            )}
            ...
            {additionalQuestions.length > 0 && (
              <div className="additional-questions">
                {additionalQuestions.map((question, index) => (
                  <div key={index} className="form-group-3">
